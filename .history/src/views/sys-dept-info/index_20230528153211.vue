...
const initMap = () => {
  ...
  AMapLoader.load({
    ...
    const marker = new AMap.Marker({
      position: new AMap.lonLat(ruleForm.lon, ruleForm.lat), // 经纬度对象，也可以是经纬度构成的一维数组[116.39, 39.9]
      title: '打卡',
    })
    ...
    >
      ...
      >
        ...
        <el-form-item label="打卡坐标中心点" required>
          <div class="w-full h-200px bg-red-300 standardMap">
            <p><strong>经度：</strong>{{ ruleForm.lon || '还未打卡' }}  <strong class="ml-3"> 纬度：</strong>   {{ ruleForm.lat || '还未打卡' }}</p>
