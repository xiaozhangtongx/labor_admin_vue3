  ...
  <div v-loading="isLoading" class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="打卡半径" prop="des" required>
          <el-input-number
        ...
        <el-form-item label="打卡坐标中心点" prop="des" required>
          <div class="w-350px h-200px bg-red-300 standardMap" />
          <Screenfull element=".standardMap" open-tips="审批表全屏" class="absolute right-0 top-0" />
        </el-form-item>
